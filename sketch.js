...
function preload() {
  ...
  sadzombie = loadImage("assets/zombie1.png");

  backgroundImage = loadImage("assets/background.png");
  
  deadZombie = loadAnimation("assets/dead.png")
}
...
function setup() {
  ...
  bridge = new Bridge(27, { x: 50, y: height / 2 - 100 });
  ...
  zombie.addAnimation("dead",deadZombie)
...
function handleButtonPress() {
  ...
  zombie.changeAnimation("dead",deadZombie)
  zombie.scale = 0.5
}